...
<script src="js/languages/jquery.validationEngine-pt_BR.js"
...
<body>
	...
	<br />
	<br />
	<form id="form1" name="form1" class="form-signin" method="post"
		action="login.php">
		<a href="http://www.casaruibarbosa.gov.br/"> <img
			src="imagens/logo.jpg" alt="" width="720" height="120"
			style="display: block; margin-left: auto; margin-right: auto" /> </a>
		<H4>MOVIMENTAÇÃO DO ALMOXARIFADO - RMA</h4>
		<div class="form-actions">

			<label class="control-label" for="inputEmail"><i class="icon-user"></i>Usuário</label>
			<div class="controls">
				<input type="text"
					class="validate[required,minSize[6]],custom[onlyLetterNumber] text-input"
			...
			<div class="controls">
				<input type="password" class="validate[required,minSize[6]]"
					placeholder="Senha" name="senha" size="20" tabindex="2">
			</div>
			<div class="control-label">
				...
				<label id="erromsg" class="label-success"
					style="color: #FFFFFF; font-style: normal; font-weight: bold"></label>
				<label id="erro"
					style="color: #FFFFFF; font-style: normal; font-weight: bold"
		...
		<footer class="footer-inverse ">
			<p>Copyright Central IT 2013. All rights reserved.</p>
		</footer>
	</form>
