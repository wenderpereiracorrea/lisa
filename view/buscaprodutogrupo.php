...
$sql = "SELECT  * FROM categoria where (nome LIKE '%%%$valorBusca%%') LIMIT 30;";
...
<a href="addprodutogrupo.php"  class="btn btn-large btn-primary"><i class="icon-plus icon-white"></i> Adicionar</a>
<!--=============================================================
	JS
	=============================================================-->
...
<table style="width: 100%; border: solid 1px #ddd;" class="table table-bordered" cellpadding="4" cellspacing="4">
	...
	<table style="width: 100%; border: solid 1px #ddd;"	class="table table-bordered" cellpadding="4" cellspacing="4">
		...
		$valprod = $array_exibir['codcategoria']
			?>
		<!-- Inicio da formação dos links para exibir a consulta -->
		<tr>
			<td style="background-color: #f5f5f5;"><a href="addprodutogrupo.php?modo=parc&idprocesso=<?echo $valprod?>">
			<? echo $array_exibir['codgrupo'] ?></a>
			</td>
			<td style="background-color: #f5f5f5;"><a href="addprodutogrupo.php?modo=parc&idprocesso=<?echo $valprod?>">
			...
			<td>
			 <a href="addprodutogrupo.php?modo=parc&idprocesso=<?echo $valprod?>"><i class="icon-edit"></i> Alterar</a>
			</td>
			<?
			$i++;
		}
