...
function buscaInstantanea() {
	if(document.getElementById) { // Para os browsers complacentes com o DOM W3C.
		var termo = document.getElementById('pesquisagrupo').value; // Pega o termo digitado no campo de texto.
		...
		if(termo !== "" && termo !== null && termo.length >= 0) { // Verifica se o campo não está vazio, ou se foi digitado no mínimo três caracteres.
			...
			ajax.open("GET", "view/buscaprodutogrupo.php?q=" + termo, true); // Envia o termo da busca como uma querystring, nos possibilitando o filtro na busca.
