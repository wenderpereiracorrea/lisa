...
?>
<?
$sql = "SELECT * FROM precoproduto as prevend
where prevend.produto_idproduto =  '$valorBusca' AND
quantidade <> 0
...
<? echo "FAVOR REFINAR A CONSULTA SOMENTE OS PRIMEIROS 30 ITENS SÃO EXIBIDOS"?>
    ...
    ............ Estoque: <? echo strtoupper($array_exibir['quantidade']) ?>
	</option>
    <? $i++; } ?>
    </select>
<? if ($valprod == ""){
...
<label>Quantidade para baixa</label>
      <input class="validate[required,custom[integer]]" value="<?php echo $txtquantidadepedido; ?>" onclick"" name="txtquantidadepedido"  id="idtxtquantidadepedido" type="text" placeholder="0">
